...
export const pricing: PricingItem[] = [
    ...
    { id: 3, name: "Enterprise", description: "For Profitable Startups and Large Corps", amount: "$ 5999" , features: ["Unlimited Advisory Hours / Month","Sprint Planning & Roadmaps", "Architecture & Tech Stack Review", "Product Development", "Feature Development", "On‑Call Support", "Dedicated Slack Channel", "Custom Service Level Agreement"]}
]   
