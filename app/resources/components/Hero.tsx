...
const heroItems = {
    title: "Product Design Checklist for Founders",
    subtitle:
        "This concise PDF covers all the essential questions you should ask yourself - from validating user needs and sketching wireframes to running rapid usability tests, so your product is both user-friendly and investor-ready",
};
